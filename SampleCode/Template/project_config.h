...
#define _debug_log_SPIM_ERASE_			(1)
#define _debug_log_SPIM_VERIFY_ERASE_	(1)
#define _debug_log_SPIM_PROGRAMMING_	(1)
#define _debug_log_SPIM_DMA_READ_		(1)
#define _debug_log_SPIM_DMM_READ_		(1)


#define ENABLE_M487_ETM_SPIM			// PA0 ~ PA3
//#define ENABLE_M487_PFM_SPIM			// PC0 ~ PC3	
